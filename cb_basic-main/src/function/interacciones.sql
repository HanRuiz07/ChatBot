CREATE OR REPLACE FUNCTION public.sp_crear_interaccion(
	p_cod_red TEXT,
	p_cod_ses TEXT,
    p_id_whats TEXT,    
	p_name_whats TEXT,
...
CREATE OR REPLACE FUNCTION public.sp_guardar_opciones(
    p_id_whats TEXT, 
    p_option TEXT, 
    p_campo TEXT
) RETURNS JSONB AS $$
...
CREATE OR REPLACE FUNCTION public.sp_guardar_informacion(
    p_id_whats TEXT, 
    p_option TEXT, 
    p_campo TEXT
) RETURNS JSONB AS $$
