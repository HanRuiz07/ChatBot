...
import { saveInformationToDatabase, saveOptionToDatabase } from '~/Servicios/postresql';
import Dengue_3 from './Dengue_3';

const auxEnc4 = {};

const Encuesta_Dengue_5 = addKeyword(EVENTS.ACTION)
...
export default Encuesta_Dengue_5