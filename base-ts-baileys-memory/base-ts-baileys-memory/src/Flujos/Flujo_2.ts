...
const Flujo_2=addKeyword(EVENTS.ACTION).
                addAction(async(ctx, {gotoFlow})=>{start(ctx,gotoFlow, 300000)}).
                addAnswer([
                    '🏥 *Servicios Médicos Disponibles en el Hospital Pablo Bermudez*:',
                    '',
                ...
                addAnswer(
                    null, {capture:true}, async(ctx, {state, gotoFlow, flowDynamic, endFlow, fallBack}) => {
